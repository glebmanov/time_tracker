...
module.exports = {
  ...
  safelist: [
    ...
    {
      pattern:
        /hover:bg-(slate|gray|zinc|neutral|stone|red|orange|amber|yellow|lime|green|emerald|teal|cyan|sky|blue|indigo|violet|purple|fuchsia|pink|rose)-(100|200|300|400|500)/,
    },
  ],
  theme: {
    extend: {
